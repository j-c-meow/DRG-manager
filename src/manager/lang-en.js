...
const I18N_EN = {
  ...
  /* —— 深度玩法（Wave-1 收尾）：硬壳富矿 / 自由采挖窗 / 巢穴守卫腿 / 自检防御窗 —— */
  '硬壳破开了——里面是一整块富矿！':'The shell cracked open — a whole rich chunk inside!',
  '矿结采空——硬壳里还封着富矿！':'Nodule tapped out — a rich chunk is still sealed in the shell!',
  '按住左键 钻穿硬壳':'Hold LMB to crack the shell',
  '采出富矿块！入库计 2（按 E 扛起来）':'Rich chunk extracted! Counts double on deposit (press E to carry)',
  '富矿块':'Rich chunk',
  '（富矿 +2）':' (rich +2)',
  '配额达成！飞船 60 秒后抵达——想多搬几块就抓紧，按 R 可随时提前撤离。':'Quota met! The Drop Pod lands in 60 seconds — grab extra chunks if you dare, press R to leave early.',
  '配额达成 · 自由采挖窗 60 秒开启':'Quota met · 60s free-mining window open',
  '自由采挖 · 想搬就继续搬':'Free mining · keep hauling if you dare',
  '自由采挖窗 ':'Free-mining window ',
  's · 按 R 提前呼叫':'s · press R to call early',
  '飞船抵达倒计时 ':'Pod arrival countdown ',
  '硬壳富矿':'Shelled rich vein',
  '发着金光的矿结封在硬壳里——钻穿它，采出双倍富矿块':'Golden nodules are sealed in hard shells — crack them open for double-value rich chunks',
  '缠着虫巢的腿附近有守卫——备好武器再靠近；修好后她还要自检 45 秒':'Webs mean guards nearby — arm up before approaching; after repairs she runs a 45s self-check',
  '守卫矿骡腿':'Guarded M.U.L.E. leg',
  '矿骡修好了！她正在启动自检——守住她 45 秒，我们马上回家！':"The M.U.L.E. is fixed! She's running her self-check now — hold the line for 45 seconds and we're going home!",
  '自检防御 · 顶住 45 秒':'Self-check defense · hold for 45 seconds',
  'MULE 自检中 · 顶住防御波 ':'M.U.L.E. self-check · survive the waves ',
  ' ⚡ 派遣事件 · ':' ⚡ Dispatch Event · ',
