...
const MEME_EVENTS = {
  ...
  pool: [
    ...
    { id:'ev_goldbug',   w:2 },
    /* —— 扩容包（v1.2，30 事件 × 6 键，权重 3：单项稀有、总量约半）—— */
    { id:'ev_lootpet',     w:3 },
    { id:'ev_lookupleech', w:3 },
    { id:'ev_huuli',       w:3 },
    { id:'ev_crisp',       w:3 },
    { id:'ev_frogbelly',   w:3 },
    { id:'ev_supplydrop',  w:3 },
    { id:'ev_grebeard',    w:3 },
    { id:'ev_trapfun',     w:3 },
    { id:'ev_bosco',       w:3 },
    { id:'ev_redsugar',    w:3 },
    { id:'ev_surf',        w:3 },
    { id:'ev_lastcall',    w:3 },
    { id:'ev_jukebox',     w:3,  require:'bar' },
    { id:'ev_dance',       w:3 },
    { id:'ev_incinerator', w:3 },
    { id:'ev_jetboot',     w:3 },
    { id:'ev_mask',        w:3 },
    { id:'ev_pointer',     w:3 },
    { id:'ev_karlfund',    w:3 },
    { id:'ev_appeal',      w:3 },
    { id:'ev_friday',      w:3,  require:'bar' },
    { id:'ev_audit',       w:3 },
    { id:'ev_tax',         w:3 },
    { id:'ev_overtime',    w:3 },
    { id:'ev_teambuild',   w:3 },
...
/* ================= 社区梗事件扩容包（v1.2，30 事件 × 6 键） ================= */
/* 每条均为「派遣途中发生的小事故/小机遇」，确定性二选一；效果走 resolveEvent meme 分支（missions.js）。 */
Object.assign(TEXT, {

// —— 扩 1 掠夺虫吉祥物（梗：掠夺虫宠物/愧疚文化，杀虫道歉社区传统）——
ev_lootpet_title: "掠夺虫吉祥物计划",
ev_lootpet_desc: "一只圆滚滚的掠夺虫蹲在矿道口，吃矿的样子和财务部吃预算一样专注。全队已经给它起好了名字，就差一个编制。",
ev_lootpet_a_btn: "留作钻台吉祥物",
ev_lootpet_a_result: "它被命名为「17号钻台编外主任」，主要工作是吃矿——这一点和历任主任都很像。士气大涨，产出略亏：养虫也要口粮。",
ev_lootpet_b_btn: "上缴矿物部门",
ev_lootpet_b_result: "掠夺虫已入库，折算代币到账。工会当晚收到一封悼词，全文两句：「它很圆。它很好。」士气小降。",

// —— 扩 2 抬头安全运动（梗：洞穴水蛭官方宣传「LOOK OUT. LOOK UP.」）——
ev_lookupleech_title: "「抬头看」安全运动预算案",
ev_lookupleech_desc: "安全顾问申请预算：全矿张贴「抬头看」海报，并为新人配发头顶探照灯。依据：新人失踪报告里出现频率最高的一句话——「他刚才还在这里。」",
ev_lookupleech_a_btn: "海报探照灯全配",
ev_lookupleech_a_result: "海报上护林员加尔法克斯瞪着所有人。现在连不去矿区的文员都会条件反射抬头。工期顺延，安全感大涨。",
ev_lookupleech_b_btn: "口头提醒省钱",
ev_lookupleech_b_result: "老矿工的口头提醒共四个字，三个是「抬头看」，剩下一个是叹气。预算省下了——大约省出了一张医疗账单。",

// —— 扩 3 胡力囤积虫（梗：Huuli Hoarder 过境，全队丢下任务围捕的名场面）——
ev_huuli_title: "胡力囤积虫过境",
ev_huuli_desc: "一只胡力囤积虫驮着满背稀有矿横穿矿道，步伐从容，像一位刚审计完全部分部的老爷。全队的呼吸停了半拍。",
ev_huuli_a_btn: "全员围捕",
ev_huuli_a_result: "围捕用时九分钟，它交出的存货比本季度的申报单还体面。稀有矿物大额入账，工期顺延。",
ev_huuli_b_btn: "目送离开",
ev_huuli_b_result: "全队目送它消失在矿道尽头，没有人说话。进度正常，士气小降——当班记录里写满了「尊重，但心痛」。",

// —— 扩 4 三晶石物流（梗：三提石任务与 CRISP 欢呼）——
ev_crisp_title: "三晶石物流难题",
ev_crisp_desc: "一颗巨型三晶石卡在矿道正中央。绕行，多走两公里；拖运，得全员上。任务指挥提醒：公司只认签收单，不认合影。",
ev_crisp_a_btn: "全员拖运",
ev_crisp_a_result: "全队喊着号子把三晶石拖上矿骡，稀有矿物入账，工期顺延。没人喊累——因为喊累的力气也没了。",
ev_crisp_b_btn: "就地引爆取样",
ev_crisp_b_result: "引爆很干脆，样本很完整，折算代币到账。士气小降：那声闷响之后，矿道安静得像在为碎掉的奖金默哀。",

// —— 扩 5 肚皮蛙吞矿（梗：圆滚滚洞穴生物吞矿，社区宠物化改编）——
ev_frogbelly_title: "肚皮蛙吞矿事故",
ev_frogbelly_desc: "一只圆滚滚的蛙形洞穴生物——矿工们管它叫「肚皮蛙」——吞下了整袋墨菱石，正躺在原地消化，肚皮上的矿脉清晰可见。",
ev_frogbelly_a_btn: "开膛取矿",
ev_frogbelly_a_result: "取矿顺利，代币大额到账。肚皮蛙被放生时回头看了一眼，那眼神已被全员自动翻译为「记仇」。士气小降。",
ev_frogbelly_b_btn: "等它消化完",
ev_frogbelly_b_result: "全队陪着肚皮蛙等了两小时。它起身抖了抖皮，什么也没吐出来，摇摇摆摆走了。士气大涨：没人为这段等待后悔。",

// —— 扩 6 补给舱砸人（梗：补给舱空投物理喜剧，「补给送达率100%，人心收敛率0%」）——
ev_supplydrop_title: "补给舱落点偏差",
ev_supplydrop_desc: "补给舱导航偏差三十米——新落点正下方站着一名矿工，还在抬头挥手。任务指挥的二选一频道难得沉默。",
ev_supplydrop_a_btn: "全员紧急引导",
ev_supplydrop_a_result: "补给舱在全队激光笔的指引下擦着安全帽落地。工期顺延，士气小涨——被瞄准的那位请全队喝了酒，以示庆祝。",
ev_supplydrop_b_btn: "按原坐标投放",
ev_supplydrop_b_result: "补给舱准时落地，一分钟都没耽误。落点旁的矿工获评本月「闪避达人」，奖品是一份自费医疗须知。",

// —— 扩 7 绿胡子带教（梗：Greenbeard/Greybeard 新老矿工文化）——
ev_grebeard_title: "绿胡子首班带队方案",
ev_grebeard_desc: "新绿胡子的首班派遣，两位灰胡子争当带教：一位主张手把手教，另一位主张「矿道是最好的老师」。",
ev_grebeard_a_btn: "灰胡子一带一",
ev_grebeard_a_result: "带教效果显著：新人学会了三件事——挖矿、打虫，以及为什么不能把雷管和午餐放同一个包。工期顺延，士气小涨。",
ev_grebeard_b_btn: "直接上岗自学",
ev_grebeard_b_result: "新人提前完工，进步神速，主要是被虫追着跑的。有概率轻伤——医疗站管这叫「学费」。",

// —— 扩 8 陷阱乐（梗：工程部坑人工事/雷阵整活）——
ev_trapfun_title: "工程师的「防御工事」",
ev_trapfun_desc: "全队被工程部自建的感应雷阵堵在矿道里。工程部辩护：「这是艺术，也是防御。」雷阵上还挂着小牌子：参观收费。",
ev_trapfun_a_btn: "命令拆除",
ev_trapfun_a_result: "拆雷用时一小时，无一伤亡。工程部撤场时在原址立了块纪念牌：「此处曾有一座伟大的雷阵。」士气小涨，工期顺延。",
ev_trapfun_b_btn: "收费参观",
ev_trapfun_b_result: "雷阵参观券热销，代币到账。士气小降：第一位游客踩响的，是工程部自己留的「彩蛋」。",

// —— 扩 9 博斯科（梗：单人模式支援无人机 Bosco，编外劳模）——
ev_bosco_title: "博斯科的求职简历",
ev_bosco_desc: "单人支援无人机博斯科停在派遣终端前，屏幕上滚动着一份简历：挖矿、打虫、泡咖啡，特长栏写着「不需要休息」。",
ev_bosco_a_btn: "纳入编制帮忙",
ev_bosco_a_result: "博斯科全程高效得像一台……它本来就是。任务提前完成，士气小涨：终于有同事不抢酒了。",
ev_bosco_b_btn: "出租给邻台",
ev_bosco_b_result: "博斯科被短期租借给 18 号钻台，租金代币到账。临走前它看了大家一眼——传感器指标一切正常，没有感情波动。应该没有。",

// —— 扩 10 红糖配给（梗：红糖治疗传统 vs 财务入账冲动）——
ev_redsugar_title: "红糖配给制提案",
ev_redsugar_desc: "财务部提议：矿道采到的红糖统一登记入库，治疗需求改为申领制。医疗站回复：「你们先问问虫同不同意。」",
ev_redsugar_a_btn: "按需取用",
ev_redsugar_a_result: "红糖维持「谁伤谁吃」的矿道传统，损耗照登。士气小涨——放心吃糖的矮人，才是好矮人。",
ev_redsugar_b_btn: "登记入账",
ev_redsugar_b_result: "红糖足额入库，账面体面，代币小涨。士气小降：从此吃糖前要先填表，表的编号比糖的结晶还多。",

// —— 扩 11 斜坡冲浪（梗：持镐滑坡社区名场面）——
ev_surf_title: "斜坡冲浪合法化试点",
ev_surf_desc: "多份影像证据显示：矿工正持镐沿矿渣斜坡滑行，姿势各异，喊的都不是安全口号。请管理层定性。",
ev_surf_a_btn: "批准试点",
ev_surf_a_result: "斜坡冲浪正式成为下班保留节目，士气大涨，有概率摔出轻伤——安全顾问把这一条记作「快乐的成本」。",
ev_surf_b_btn: "写进安全通报",
ev_surf_b_result: "通报发布：《关于禁止把矿道当滑梯的通知》。安全积分折算代币小额到账，士气小降。当晚斜坡的摩擦声没有停。",

// —— 扩 12 空投舱守则（梗：「空投舱有你们没你们都会起飞」官方台词）——
ev_lastcall_title: "空投舱登舱守则修订",
ev_lastcall_desc: "任务指挥重申守则第一条：「空投舱有你们没你们都会起飞。」全队联名请愿修订第一条：等最后一个矮人。",
ev_lastcall_a_btn: "准点起飞",
ev_lastcall_a_result: "空投舱准点起飞，守则得到捍卫，任务提前收尾。士气小降——回程舱里安静得能听见有人在数人头。",
ev_lastcall_b_btn: "等最后一人",
ev_lastcall_b_result: "空投舱多等了两分钟，全员到齐。士气大涨，任务顺延。任务指挥的备忘录新增一行：「他们真的会等。」",

// —— 扩 13 点唱机（梗：酒吧点唱机贴脸合唱）——
ev_jukebox_title: "点唱机包周申请",
ev_jukebox_desc: "酒吧点唱机提交申请：包周免费点歌，曲目由全员轮流决定。财务部质询：「跳舞算工时吗？」",
ev_jukebox_a_btn: "免费点歌一周",
ev_jukebox_a_result: "包周成功，酒吧连夜改成排练厅，士气大涨，工期顺延——第一支舞的搭子，比第一镐的搭档还难找。",
ev_jukebox_b_btn: "设为付费点歌",
ev_jukebox_b_result: "点歌机接入收费系统，代币到账。士气小降：免费歌单只剩一首《集团是我的家》，点唱率百分之百——因为只有这一首。",

// —— 扩 14 舱口舞会（梗：结算前空投舱口集体跳舞仪式）——
ev_dance_title: "结算前舱口舞会审批",
ev_dance_desc: "空投舱口出现自发性集体舞会，参与率 100%，安全顾问已在一旁举起秒表。请在「批准」与「按流程登舱」之间拍板。",
ev_dance_a_btn: "批准舞会",
ev_dance_a_result: "舞会批准，耗时十分钟，动作难度评审未通过，但气氛满分，士气大涨。安全顾问的秒表按成了拍照模式。",
ev_dance_b_btn: "按流程登舱",
ev_dance_b_result: "全员按流程登舱，提前归航。士气小降：返程途中，每一顶安全帽的反光看起来都有些落寞。",

// —— 扩 15 焚化炉扣篮（梗：抱桶跳焚化炉铁圈的官方成就速通法）——
ev_incinerator_title: "焚化炉扣篮大赛申办",
ev_incinerator_desc: "员工申请在焚化炉上举办酒桶扣篮大赛，引用官方成就为依据。安全条款：人和酒桶，只能有一个进铁圈。",
ev_incinerator_a_btn: "举办大赛",
ev_incinerator_a_result: "大赛圆满举办，最高分得主捧走「金桶奖」，士气大涨，燃料损耗小额——焚化炉毫无怨言，甚至觉得很暖。",
ev_incinerator_b_btn: "叫停活动",
ev_incinerator_b_result: "活动叫停，违规酒桶没收变卖，代币小到账，士气小降。当晚焚化炉的铁圈边，站了一圈欲言又止的矮人。",

// —— 扩 16 街机锦标赛（梗：Jetty Boot 高分榜混进劳埃德）——
ev_jetboot_title: "街机锦标赛赞助案",
ev_jetboot_desc: "《喷气靴小子》锦标赛的申办材料附有一条备注：上届冠军疑似为劳埃德本人。赛事方申请公司赞助。",
ev_jetboot_a_btn: "赞助锦标赛",
ev_jetboot_a_result: "锦标赛批准，奖金为代币，奖杯为镀金小酒杯，士气大涨。劳埃德的屏幕连闪三次——业内解读为「卫冕宣言」。",
ev_jetboot_b_btn: "设为绩效指标",
ev_jetboot_b_result: "街机高分纳入绩效加分，报名费代币到账，士气小降。劳埃德已就「选手资格真实性」申请复核。",

// —— 扩 17 橡皮面具（梗：「恐怖橡皮面具」=任务指挥的脸）——
ev_mask_title: "恐怖橡皮面具经销案",
ev_mask_desc: "后勤部到货一批「任务指挥同款」恐怖橡皮面具，宣传语：「戴上它，人人都是管理层。」请批示。",
ev_mask_a_btn: "发给当月之星",
ev_mask_a_result: "面具发给当月之星。他戴着面具走进酒吧那晚，任务指挥罕见地没有引用管理层。士气大涨，工期微延。",
ev_mask_b_btn: "全部没收变卖",
ev_mask_b_result: "没收清单：面具 ×17，尊严 ×若干。变卖代币到账，士气小降。据说任务指挥自己也偷偷买了一个。",

// —— 扩 18 激光笔（梗：指哪喊哪的激光笔宗教，黄金39%/蘑菇41%/目标20%）——
ev_pointer_title: "激光笔换装采购案",
ev_pointer_desc: "设备部报告：现役激光笔平均寿命已到，标黄金会闪、标蘑菇出双影。换装采购案已拟，预算待批。",
ev_pointer_a_btn: "全员换新款",
ev_pointer_a_result: "新款到货，标哪哪亮，士气大涨。本月标记统计：黄金 39%，蘑菇 41%，任务目标 20%——传统没有变。",
ev_pointer_b_btn: "维修旧款",
ev_pointer_b_result: "旧激光笔勉强修好，偶尔把任务目标标成蘑菇。工期微延，士气小降。财务部表扬了这笔「节约」。",

// —— 扩 19 卡尔基金（梗：For Karl 举杯礼/「他一定会回来喝」）——
ev_karlfund_title: "卡尔纪念日基金",
ev_karlfund_desc: "工会申请设立「卡尔纪念日」专项基金：举杯一次，计提一笔，用途保密——据说和「他一定会回来喝」有关。",
ev_karlfund_a_btn: "设立基金",
ev_karlfund_a_result: "基金设立，首轮已入账。当晚全队举杯，士气大涨。没有人问基金的去向——问了，就像在问卡尔回不回来。",
ev_karlfund_b_btn: "改为一分钟默哀",
ev_karlfund_b_result: "默哀方案试行，省下预算，工期微缩，士气小降。一分钟的安静里，有人听见了吧台方向很轻的一句：「……酒不错。」",

// —— 扩 20 申诉通道（梗：「与管理层谈话」引用狂魔）——
ev_appeal_title: "员工申诉通道提案",
ev_appeal_desc: "人事部提案：开设「与管理层谈话」正式申诉通道，预计每月产生文书 214 份。附言：谈话本身免费。",
ev_appeal_a_btn: "开放申诉通道",
ev_appeal_a_result: "通道开放，首日收件 217 份，其中 214 份主题为「申请更多的与管理层谈话」。士气大涨，文书工期顺延。",
ev_appeal_b_btn: "维持现状",
ev_appeal_b_result: "提案婉拒，申诉继续走意见箱，代币小额节省，士气小降。意见箱本周第三次被塞满——这次还塞进了一顶安全帽。",

// —— 扩 21 周五酒会（梗：团建报销体：「附件照片217张，200张是模糊的举杯」）——
ev_friday_title: "周五酒会预算案",
ev_friday_desc: "酒吧提交周五酒会预算，事由栏工整写着「团队建设」，附件照片 217 张，其中 200 张是模糊的举杯。",
ev_friday_a_btn: "报销全场第一轮",
ev_friday_a_result: "第一轮全报，士气大涨，代币支出。次日简报只有一句：「昨天挖到的不是矿，是感情。」",
ev_friday_b_btn: "只报无酒精批次",
ev_friday_b_result: "无酒精批次到货，预算省下六成。两分钟后，全部批次被倒进同一盆观叶植物——那盆植物现在也站着晃。士气小降。",

// —— 扩 22 母舰审计（管理向改编：总部母舰审计团到访）——
ev_audit_title: "母舰审计团到访",
ev_audit_desc: "总部母舰审计团空降 17 号钻台，全员对账。审计官开场白：「我们只是路过银河。带着表格。」",
ev_audit_a_btn: "全员加班对账",
ev_audit_a_result: "对账通宵完成，审计全优，奖励代币到账，士气大降——士气报表也因此非常好审：只有一格。",
ev_audit_b_btn: "请审计团去酒吧",
ev_audit_b_result: "审计团在酒吧坐到第三轮，临走批语：「数字有弹性，矮人没有。」审计顺利通过，士气小涨，招待费已列支。",

// —— 扩 23 矿业税（管理向改编：税务稽查与古董条例漏洞）——
ev_tax_title: "矿业税稽查通知",
ev_tax_desc: "税务部门稽查通知送达：本季度墨菱石销售「存在申报口径争议」。会计部的脸色，比最深层的岩壁还黑。",
ev_tax_a_btn: "如数补缴",
ev_tax_a_result: "税款如数补缴，代币大额流出，士气小降。财务部把缴款凭证裱了起来，标题：《成本，也是贡献》。",
ev_tax_b_btn: "启用旧漏洞",
ev_tax_b_result: "会计部启用 1987 年版《矿业税务条例》第 41 条，税额大减，士气小涨。条例原文第一句：「本条不应再被使用。」",

// —— 扩 24 加班（管理向改编：「自愿」加班倡议书）——
ev_overtime_title: "「自愿」加班倡议书",
ev_overtime_desc: "为赶回本单工期，管理层起草《自愿加班倡议书》。法务部批注：「『自愿』的引号必须保留，一个都不能删。」",
ev_overtime_a_btn: "发加班费赶工",
ev_overtime_a_result: "加班费足额发放，任务提前完成，士气小涨——领到钱的矮人表示，自愿得非常发自内心。",
ev_overtime_b_btn: "精神鼓励赶工",
ev_overtime_b_result: "倡议书全文宣读，核心激励为一枚虚拟勋章。任务同样提前完成，士气大降：勋章尺寸很大，正好挡住工资条。",

// —— 扩 25 团建（管理向改编：团建套餐比选）——
ev_teambuild_title: "团建套餐比选",
ev_teambuild_desc: "人事部呈上团建两案：A 案「矿道拉练」，B 案「取消团建，省下预算」。备注：两案的支持率都曾达到 100%。",
ev_teambuild_a_btn: "矿道拉练",
ev_teambuild_a_result: "拉练举行，全员背着矿袋爬了三层矿道，士气大涨，工期顺延。人事部总结：「累，但是一起累。」",
ev_teambuild_b_btn: "取消省预算",
ev_teambuild_b_result: "团建取消，预算代币入账，士气小降。次日通知栏出现手写补丁：「今日团建项目：目视放弃团建的自己。」",

// —— 扩 26 咖啡（管理向改编：咖啡机 vs 黑墨菱酒，官方梗「工程可以去泡咖啡了」）——
ev_coffee_title: "咖啡机采购案",
ev_coffee_desc: "工程部申请采购工业级咖啡机，理由：「咖啡因也是燃料，而且是唯一不炸的那种。」备选方案：继续喝黑墨菱酒上班。",
ev_coffee_a_btn: "采购咖啡机",
ev_coffee_a_result: "咖啡机到货，任务提速完成，士气小涨。工程部人均清醒十八小时——新图纸上每只虫都被多画了两条腿。",
ev_coffee_b_btn: "继续喝黑墨菱酒",
ev_coffee_b_result: "黑墨菱酒管够，士气大涨，工期顺延。用酒精度数换工程进度的账，财务部拒绝出报告。",

// —— 扩 27 打印机（管理向改编：结算报表打印机罢工）——
ev_printer_title: "报表打印机罢工",
ev_printer_desc: "结算报表打印机集体罢工，屏显故障码：「NO。」行政部确认：这是它打印过的第一句真话。",
ev_printer_a_btn: "请工程部抢修",
ev_printer_a_result: "工程部连夜抢修，打印机复活并补打全部欠账，士气小涨。它现在的屏显换成了：「给酒。就干。」预算已批。",
ev_printer_b_btn: "全员手抄报表",
ev_printer_b_result: "全员手抄报表，字迹从工整到狂草再到象形。工期顺延，士气小降。历史上第一次，全队一致怀念机器。",

// —— 扩 28 纪念堂（管理向改编：纪念堂铭牌升级，拒绝广告位）——
ev_memorial_title: "纪念堂升级提案",
ev_memorial_desc: "纪念堂铭牌年久失修。两案待批：A 案铭牌镀金，B 案改电子屏——供应商承诺「可轮播，还带广告位」。",
ev_memorial_a_btn: "铭牌镀金",
ev_memorial_a_result: "铭牌镀金完成，刻名在灯下庄重发亮，士气大涨。管理层批注：这笔钱花得比任何一单都像矿业。",
ev_memorial_b_btn: "改电子屏",
ev_memorial_b_result: "电子屏上线，刻名轮播，间隙播出「精益采矿」广告。代币小额到账，士气大降：英雄的名字，不该有贴片广告。",

// —— 扩 29 岩石坞（管理向改编：坞门刮蹭定损，保险不赔梗）——
ev_dock_title: "岩石坞定损单",
ev_dock_desc: "岩石坞坞门新增三道刮痕，肇事方不明，目击证词统一：「是门自己撞上来的。」定损单已送抵管理层案头。",
ev_dock_a_btn: "自检自修",
ev_dock_a_result: "全队自发打磨补漆，工期顺延，材料费小额，士气小涨——那三道刮痕现在被漆成了一面小小的公会旗。",
ev_dock_b_btn: "走保险流程",
ev_dock_b_result: "保险以「刮痕成因存疑」为由拒赔，代币照单支出，士气小降。保单第 7 条再次应验：保险不赔，包括不赔保险。",

// —— 扩 30 钢熊周边（管理向改编：动力甲玩具熊周边经销）——
ev_steelbear_title: "「钢熊」周边上架案",
ev_steelbear_desc: "商店申请上架「钢熊」系列周边：穿动力甲的玩具熊，口号「硬得像钢，熊得像你」。样品已萌倒三名枪手。",
ev_steelbear_a_btn: "采购一批",
ev_steelbear_a_result: "钢熊玩偶全员人手一只，士气大涨，代币支出。本月工伤率随之下降——大家都忙着给熊摆姿势，忘了赌拳。",
ev_steelbear_b_btn: "限量拍卖",
ev_steelbear_b_result: "限量十七只，拍卖代币大额到账，士气小降。落选者已自动列队预约「钢熊二代」——涨价通知的原话出自财务部。",
